...
# make sure your current style template matches the name below old: LegalDocsTemplate.docx
# you also need an 'output' folder created
def makeNewDocx(newpath,dn):
    stylepath="StylesTemplateB.docx"
